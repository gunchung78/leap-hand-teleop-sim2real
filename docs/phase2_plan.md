...
**S3 완료 (08-24)** v0-dr 1e8 스텝 (66.8M + 이어 돌리기 34M). 평가 angvel 합(확률적) 0 → 311(66M) → 426(100M), 에피소드 길이 ≈490/500.
**최종 v0** CPU 재생 5 에피소드: **0.64 rad/s 평균**(0.08 / 0.66 / 0.83 / 0.81 / 0.83 — 한 에피소드는 정체), 낙하 0/5,
토크 RMS 0.186 N·m, >350 mA 비율 73%, rot 사용 if[−14,10] mf[−7,32] rf[−21,21]°. `models/rotate_z_v0.npz`.

**S4 진행 중 (08-24 08:40)** v1-lite: `p2_4_train_lite.py --num_timesteps 1e8 --domain_randomization` (토크 상한 0.128, 벌점).
